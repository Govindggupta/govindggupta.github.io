    ...
    >
      <article className="flex h-full flex-col p-4">
        ...
        <div className="-mx-4 mt-4 -mb-4 h-40 overflow-hidden rounded-b-2xl">
          <div className="aspect-video origin-bottom-right translate-x-9 translate-y-1 -rotate-5 transform-gpu overflow-hidden rounded-2xl border border-t border-black/12 border-t-border bg-neutral-100 shadow-[0_4px_10px_rgba(0,0,0,0.18)] transition-transform duration-150 ease-out group-hover:-rotate-1 dark:border-border dark:bg-neutral-900 dark:shadow-none">
            {previewUrl ? (
